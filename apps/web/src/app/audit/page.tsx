...
export default function AuditPage() {
  ...
  const inputClass =
    "w-full bg-[#0f0f10] border border-[#27272a] rounded-lg px-3 py-2.5 text-sm text-[#fafafa] placeholder-[#52525b] focus:outline-none focus:border-[#2563eb] transition-colors";

  const selectClass =
    "w-full bg-[#0f0f10] border border-[#27272a] rounded-lg px-3 py-2.5 text-sm text-[#fafafa] focus:outline-none focus:border-[#2563eb] transition-colors appearance-none";
  ...
  return (
    <main className="min-h-screen bg-[#09090b] text-[#fafafa] relative overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center, rgba(9,9,11,0.5) 0%, rgba(9,9,11,0.85) 100%)",
        }}
      />
        ...
        <AnimatePresence mode="wait" custom={direction}>
          {step === 1 && (
            ...
            >
              ...
              <p className="text-sm text-[#71717a] mb-10">
                This helps us calibrate recommendations for your team size.
              </p>
              ...
              <button
                onClick={() => goTo(2)}
                disabled={!teamSize || parseInt(teamSize) < 1}
                className="mt-10 inline-flex items-center gap-2 bg-[#2563eb] hover:bg-[#1d4ed8] disabled:opacity-40 disabled:cursor-not-allowed text-white text-sm font-medium px-5 py-2.5 rounded-lg transition-all hover:shadow-[0_0_20px_rgba(37,99,235,0.4)]"
              >
                Continue
          ...
          {step === 2 && (
            ...
            >
              ...
              <p className="text-sm text-[#71717a] mb-10">
                Add every AI subscription your team pays for.
              </p>
              ...
              <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <select
                          value={sub.toolName}
                          onChange={(e) =>
                            updateTool(i, "toolName", e.target.value)
                          }
                      ...
                      <div>
                        ...
                        <select
                          value={sub.planName}
                          onChange={(e) =>
                            updateTool(i, "planName", e.target.value)
                          }
                          className={selectClass}
                        >
                          {(PLAN_OPTIONS[sub.toolName] || ["Pro"]).map((p) => (
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            updateTool(i, "monthlyPrice", e.target.value)
                          }
                          className={inputClass}
                        />
                      </div>
                ...
                <button
                  onClick={addTool}
                  className="w-full border border-dashed border-[#27272a] hover:border-[#2563eb]/50 rounded-xl py-3 text-sm text-[#52525b] hover:text-[#3b82f6] transition-all flex items-center justify-center gap-2"
                >
              ...
              <div className="flex items-center gap-3 mt-10">
                ...
                <button
                  onClick={() => goTo(3)}
                  disabled={subscriptions.some((s) => !s.monthlyPrice)}
                  className="inline-flex items-center gap-2 bg-[#2563eb] hover:bg-[#1d4ed8] disabled:opacity-40 disabled:cursor-not-allowed text-white text-sm font-medium px-5 py-2.5 rounded-lg transition-all hover:shadow-[0_0_20px_rgba(37,99,235,0.4)]"
                >
                  Continue
                  <ArrowRight className="w-4 h-4" />
                </button>
          ...
          {step === 3 && (
            ...
            >
              ...
              <h1 className="text-3xl font-semibold tracking-tight mb-2">
                Review and run audit
              </h1>
              <p className="text-sm text-[#71717a] mb-10">
                Confirm your details and we'll generate your report instantly.
              </p>
              ...
              <div className="bg-[#0f0f10]/80 backdrop-blur-sm border border-[#27272a] rounded-xl p-5 mb-4">
                ...
                <p className="text-sm">
                  {companyName || "Your team"} &mdash;{" "}
                  <span className="font-mono">{teamSize}</span> members
                </p>
              </div>
                ...
                <div className="space-y-2">
                  {subscriptions.map((sub, i) => (
                    ...
                    >
                      ...
                      <span className="font-mono text-[#fafafa]">
                        ${Number(sub.monthlyPrice).toFixed(0)}/mo
                      </span>
                    </div>
                  ))}
                  <div className="border-t border-[#27272a] pt-2 mt-2 flex justify-between text-sm">
                    ...
                    <span className="font-mono font-medium">
                      $
                      {subscriptions
                        .reduce((s, t) => s + Number(t.monthlyPrice), 0)
                        .toFixed(0)}
                      /mo
                    </span>
                  </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  disabled={loading}
                  className="inline-flex items-center gap-2 bg-[#2563eb] hover:bg-[#1d4ed8] disabled:opacity-60 text-white text-sm font-medium px-6 py-2.5 rounded-lg transition-all hover:shadow-[0_0_20px_rgba(37,99,235,0.4)]"
                >
                  {loading ? (
                    <>
